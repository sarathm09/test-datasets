...
const getRandomNames = (n = 1) =>
    Array(n)
        .fill('')
        .map(() => characters[Math.floor(Math.random() * NUMBER_OF_CHARACTERS)].full)

const getRandomWand = () => characters[Math.floor(Math.random() * NUMBER_OF_CHARACTERS)].wand

const getRandomWands = (n = 1) =>
    Array(n)
        .fill('')
        .map(() => characters[Math.floor(Math.random() * NUMBER_OF_CHARACTERS)].wand)

const getRandomHouse = () => characters[Math.floor(Math.random() * NUMBER_OF_CHARACTERS)].house

const getRandomHouses = (n = 1) =>
    Array(n)
        .fill('')
        .map(() => characters[Math.floor(Math.random() * NUMBER_OF_CHARACTERS)].house)
...
export default { getRandomCharacter, getRandomCharacters, getRandomHouse, getRandomHouses, getRandomName, getRandomNames, getRandomWand, getRandomWands }
