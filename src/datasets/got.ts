const characters = [
    ...
    },
    {
        characterName: 'Biter',
        characterImageThumb:
            'https://images-na.ssl-images-amazon.com/images/M/MV5BNWVjOWFjNGEtYzc0MC00YjkzLTkxM2QtN2Y1MmU4NzIzOTEyXkEyXkFqcGdeQXVyMjk3NTUyOTc@._V1._SX100_SY140_.jpg',
    ...
    },
    {
        ...
        killed: ['Lancel Lannister', 'High Sparrow', 'Loras Tyrell', 'Mace Tyrell', 'Margaery Tyrell', 'Kevan Lannister', 'Tyene Sand'],
    ...
    },
    {
        ...
        killed: ['Mero', 'Prendahl na Ghezn', 'Oznak zo Pahl', 'Mossador', 'Iggo', 'Akho'],
        serves: ['Daenerys Targaryen']
    },
    {
        ...
        servedBy: ['Barristan Selmy', 'Daario Naharis', 'Grey Worm', 'Jorah Mormont', 'Missandei', 'Tyrion Lannister'],
        parentOf: ['Rhaego'],
    ...
    },
    {
        ...
        killed: ['Elia Martell', 'Rhaenys Targaryen', 'Aegon Targaryen', 'Hugh of the Vale', 'Oberyn Martell', "King's Landing Boaster", 'Faith Militant', 'Missandei', 'Qyburn'],
        killedBy: ['Sandor Clegane']
    },
    {
    ...
    },
    {
        ...
        killed: ['Aerys II Targaryen', 'Jory Cassel', 'Alton Lannister', 'Torrhen Karstark', 'Olenna Tyrell', 'Euron Greyjoy'],
    ...
    },
    {
        ...
        characterImageThumb:
            'https://images-na.ssl-images-amazon.com/images/M/MV5BYjNkNjI3ZGItZmJmMC00Y2E3LWE2M2ItYzkzMTdlMGM1ZGE2XkEyXkFqcGdeQXVyMjk3NTUyOTc@._V1._SX100_SY140_.jpg',
    ...
    },
    {
        ...
        killed: ['Master Torturer', 'Medger Cerwyn', 'Lady Cerwyn', 'Unidentified Cerwyn', 'Old Woman', 'Roose Bolton', 'Osha', 'Rickon Stark', 'Wun Wun'],
    ...
    },
    {
        ...
        houseName: 'Martell',
        characterImageThumb:
            'https://images-na.ssl-images-amazon.com/images/M/MV5BYTBkMjZhMjItN2QwYS00MTg2LTg2YzMtNWJiYjBiYmVkMDk3XkEyXkFqcGdeQXVyMjk3NTUyOTc@._V1._SX100_SY140_.jpg',
    ...
    },
    {
        ...
        killedBy: ['Arya Stark'],
        parentOf: ['Black Walder Rivers', 'Lothar Frey', 'Roslin Frey', 'Ryger Rivers'],
    ...
    },
    {
        characterName: 'Will',
        characterImageThumb:
            'https://images-na.ssl-images-amazon.com/images/M/MV5BNjZlMDJhMmUtNzFlYS00ZTI1LWI5MjUtYmZkNTRlNmZmYzJlXkEyXkFqcGdeQXVyMjk3NTUyOTc@._V1._SX100_SY140_.jpg',
...
const getRandomName = () => characters[Math.floor(Math.random() * NUMBER_OF_CHARACTERS)].characterName

const getRandomNames = (n = 1) =>
    Array(n)
        .fill('')
        .map(() => characters[Math.floor(Math.random() * NUMBER_OF_CHARACTERS)].characterName)
