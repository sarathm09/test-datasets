...
const getRandomCelestialObjects = (n = 1) =>
    Array(n)
        .fill('')
        .map(() => objects[Math.floor(Math.random() * NUMBER_OF_OBJECTS)])

const getRandomPlanets = (n = 1) =>
    Array(n)
        .fill('')
...
export default { getRandomCelestialObject, getRandomCelestialObjectName, getRandomCelestialObjects, getRandomPlanet, getRandomPlanetName, getRandomPlanets }
